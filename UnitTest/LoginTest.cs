...
namespace UnitTest
{
    ...
    public class LoginTest
    {
        ...
        public void SuccessLoginTest()
        {
            ...
            mockConnection
                .Setup(x => x.SendRequest(It.Is<string>(y => y.StartsWith("user", StringComparison.OrdinalIgnoreCase))))
                .Returns(new FtpResponse(200, "OKOK"));
            mockConnection
                .Setup(x => x.SendRequest(It.Is<string>(y => y.StartsWith("pass", StringComparison.OrdinalIgnoreCase))))
                .Returns(new FtpResponse(200, "OK"));
